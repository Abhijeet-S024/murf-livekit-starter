                ...
                {isConnected ? (
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 text-xs sm:text-sm border border-[#D9E1EC] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1769AA]/50 focus:border-[#1769AA] transition-all bg-[#F5F8FC]/50"
                    />
                    <button
                      onClick={() => {
                        if (chatText.trim()) {
                      ...
                      className="px-4 py-2 bg-[#12355B] text-white text-xs sm:text-sm font-bold rounded-xl hover:bg-[#1769AA] transition-all active:scale-95 shadow-md hover:shadow-lg"
                    >
                      Send
                    </button>
                  </div>
                ) : (
                  <p className="text-[10px] text-[#5B667A] font-semibold text-center py-2 bg-[#F5F8FC] border border-[#D9E1EC]/60 rounded-xl">
